(function($) {
  ...
  if (typeof staticGoogleMaps !== "undefined") {
    $("#canvas-map")
      ...
      .css(
        "background-image",
        "url(https://maps.googleapis.com/maps/api/staticmap?key=AIzaSyBnEQ6_AU1Q37MFrHburHYdR8eia-ZFI00&zoom=17&center=" +
  ...
  if (typeof googleMaps !== "undefined") {
    ...
    function initialize() {
      ...
      var zoomedMapType = new google.maps.StyledMapType(
        zoomedOpts,
        zoomedMapOptions,
      );
      ...
      function calcRoute(origin, selectedMode) {
        ...
        directionsService.route(request, function(response, status) {
          if (status == google.maps.DirectionsStatus.OK) {
            ...
            attribute =
              attribute.substring(0, attribute.indexOf("#") + 1) +
              "icon-" +
